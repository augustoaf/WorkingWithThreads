...
public class Storage {
	...
	public synchronized boolean add(Integer num) {
		if (this.getCounter() < 1000) {//this if is because sometimes both threads are inside the while loop and the counter value is already updated to 1000 for one of the threads before the other thread calls the add method  
